...
4. **Layer 4 — Vowel stripping**: Remove interior vowels from remaining words, keep first and last character. "compaction" → "cmpctn", "model" → "modl". Skip words <4 characters.
...
7. **Deduplication in phrase codebook** — "on the other hand" appears twice in the bootstrapped phrase list. Need deduplication in the generation pipeline.
